...
public class RhythmViewController : UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        rhythm = Rhythm(steps: Int(stepStepper.value), pulses: Int(pulseStepper.value), rotation: 0)
        rhythmView = RhythmView(rhythm: self.rhythm, frame: rect)
        
        audioController = AudioController(rhythm: rhythm, bpm: Int(bpmStepper.value), sound: "ht")
